...
if(isset($_POST['roll'])){
    ...
    if($flag)
    {
        $sql="DELETE FROM `picnic_ju` WHERE `picnic_ju`.`ROLL`=$roll";
...
<body>
    ...
    <form action="delete.php" method="post" id="form" name="form" onsubmit="return check()">
            <input id="roll" name="roll" type="text" placeholder="CLASS ROLL NUMBER" required>
            <input class="btn" type="submit" name="submit" value="DELETE" style="padding-top:2px;"> 
        </form><br><br>
